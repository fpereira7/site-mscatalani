      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 max-w-xl text-[1.05rem] leading-relaxed text-muted">
            Serviços de escritório contábil — da constituição da empresa à rotina
            mensal — com foco no que o empresário precisa decidir.
          </p>
        </div>

        <ul className="mt-14 grid gap-px bg-gold/30 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="mt-12">
          <CtaLink variant="light">Quero conversar sobre o meu caso</CtaLink>
        </div>
      </div>
    </section>
  );
